...
import {
  ...
  listRoles,
  listUsers,
  listSecurityCatalogTree,
  listUserModuleAccessTree,
...
export async function securityRoutes(app: FastifyInstance) {
  ...
  app.get('/catalogo/tipos-identificacion', { preHandler: [app.authenticate] }, async () =>
    listIdentificationTypes()
  );
  ...
  app.get('/catalogo/modulos', { preHandler: [app.authenticate] }, async () =>
    listSecurityCatalogTree()
  );
