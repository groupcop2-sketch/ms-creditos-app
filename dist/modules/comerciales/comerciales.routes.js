import { z } from 'zod';
import { createComercial, createLibranzera, listComerciales, listComercialesCatalogs, listLibranzeras, updateComercial, updateComercialEstado } from './comerciales.service.js';
...
export async function comercialesRoutes(app) {
    app.get('/catalogos', { preHandler: [app.authenticate] }, async () => listComercialesCatalogs());
    app.get('/libranzeras', { preHandler: [app.authenticate, requirePermission('libranzeras:read')] }, async () => listLibranzeras());
    ...
    app.get('/vendedores', { preHandler: [app.authenticate, requirePermission('comerciales:read')] }, async () => listComerciales());
