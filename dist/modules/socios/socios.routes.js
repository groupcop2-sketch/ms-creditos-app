...
export async function sociosRoutes(app) {
    app.get('/catalogos', { preHandler: [app.authenticate] }, async () => listSociosCatalogs());
    app.get('/', { preHandler: [app.authenticate, requirePermission('socios:read')] }, async () => listSocios());
