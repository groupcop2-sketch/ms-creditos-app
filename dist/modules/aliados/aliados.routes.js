...
export async function aliadosRoutes(app) {
    app.get('/catalogos', { preHandler: [app.authenticate] }, async () => listAliadosCatalogs());
    app.get('/', { preHandler: [app.authenticate, requirePermission('aliados:read')] }, async () => listAliados());
